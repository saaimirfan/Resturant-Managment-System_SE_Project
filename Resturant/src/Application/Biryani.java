...
public class Biryani extends JFrame {
	...
	private void initcomponent() {
		...
		lblNewLabel.setIcon(new ImageIcon(Biryani.class.getResource("/Resource/biryani/BiryaniPic.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(Biryani.class.getResource("/Resource/biryani/MuttonBiryani.png")));
		lblNewLabel_1.setBounds(10, 266, 110, 70);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(Biryani.class.getResource("/Resource/biryani/beefBiryani.png")));
		lblNewLabel_2.setBounds(10, 359, 110, 70);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon(Biryani.class.getResource("/Resource/biryani/matkaBiryani.png")));
		lblNewLabel_3.setBounds(10, 559, 110, 70);
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("");
		lblNewLabel_4.setIcon(new ImageIcon(Biryani.class.getResource("/Resource/biryani/chicken Biryani.png")));
		lblNewLabel_4.setBounds(10, 468, 110, 70);
		contentPane.add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("Mutton Biryani");
		lblNewLabel_5.setBounds(124, 294, 103, 22);
		contentPane.add(lblNewLabel_5);
		
		JLabel lblNewLabel_6 = new JLabel("Beef Biryani");
		lblNewLabel_6.setBounds(124, 387, 103, 18);
		contentPane.add(lblNewLabel_6);
		
		JLabel lblNewLabel_7 = new JLabel("Chicken Biryani");
		lblNewLabel_7.setBounds(124, 496, 103, 18);
		contentPane.add(lblNewLabel_7);
		
		JLabel lblNewLabel_8 = new JLabel("Matka Biryani");
    ...
    try {
		...
		s2 = con2.EstablishConnection().createStatement();
		 ...
		 String query2="select * from Product_price where ID = '"+chicb+"'";
		 rs2 = s2.executeQuery(query2);
		while(rs2.next()) {
			lblNewLabel_10.setText(rs2.getString("Price"));
    ...
    try {
		...
		s3 = con3.EstablishConnection().createStatement();
		 ...
		 String query3="select * from Product_price where ID = '"+mutb+"'";
		 rs3 = s3.executeQuery(query3);
		while(rs3.next()) {
			lblNewLabel_11.setText(rs3.getString("Price"));
    ...
    try {
		...
		s4 = con4.EstablishConnection().createStatement();
		 rs4 = s.executeQuery("SELECT * FROM Product_price");
		 String query4="select * from Product_price where ID = '"+matka+"'";
		 rs4 = s4.executeQuery(query4);
		while(rs4.next()) {
			lblNewLabel_12.setText(rs4.getString("Price"));
		...
		btnNewButton_4.setBounds(10, 691, 137, 28);
